    ...
    <form action="" method="post">
        ...
        <div class="signup">
            ...
            <div class="signup__body">
                ...
                <div class="row">
                    <div class="col-4 col-r">Mã sinh viên </div>
                    <div class="col-8">
                        <input type="text" class="signup__input" placeholder="" name="ma_sinh_vien">
                    </div>
                </div>

                <div class="row">
                    <div class="col-4 col-r">Khoá</div>
                    <div class="col-8">
                        <input type="text" class="signup__input" placeholder="" name="khoa">
                    </div>
                </div>
